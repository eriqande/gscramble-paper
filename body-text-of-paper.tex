...
which are common from next generation sequencing methods. Sampling alleles without 
replacement, and thereby preserving the genetic differences (or lack thereof) of populations is 
essential for avoiding the issue of RISPI---an issue that is exacerbated as the number of 
...
independent results in erroneously reduced variation in the estimation of individuals' admixture 
fractions.
