...
\subsection*{Physical Linkage Matters}

ECA STILL NEEDS TO DESCRIBE AND INCLUDE THE SIMULATIONS THAT HE DID ON THIS.
THAT WORK IS ALL DONE, I JUST NEED TO PUT IT IN HERE, ALONG WITH THE FIGURE. 
...
HEY! I SHOULD ALSO DO A SET OF SIMULATIONS IN WHICH THE 65 MARKERS ARE
SIMULATED AS IF THEY ARE INDEPENDENTLY SEGREGATING---I THINK THAT MEANS
ASSIGNING EACH TO ITS OWN CHROMOSOME.  BUT MAYBE WORRY ABOUT THAT
LATER.
...
PRETTY MUCH DONE HERE EXCEPT I WANT TO SIMULATE THINGS
UNLINKED.
%%%%%%%%%%
\begin{figure}
\newcommand{\nhbpcap}{\footnotesize Gonna need a caption}
\includegraphics[width=\columnwidth]{figures/newhybs-texed-crop.pdf}
\caption[\nhbpcap]{\nhbpcap}
