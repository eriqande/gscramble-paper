...
the expected range of admixture with $F_1$ and $F_2$ individuals having mean $Q=0.5$, and $F_2$ individuals having
...
within southeastern Missouri. We thank Yniv Palti for providing flanking sequences and the linkage map for 57K markers for making a recombination map for the steelhead/cutthroat trout example. Writing of this paper was facilitated by the Mobile High Altitude Venue for Ecological Analysis,
