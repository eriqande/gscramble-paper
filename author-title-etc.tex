...
\newcommand{\myAuthors}{Eric C. Anderson$^{*,\S}$, Rachel M. Giglio$^{\dagger}$, Timothy J. Smyser$^{\dagger}$}
\author{Eric C. Anderson$^{*,\S}$, Rachel M. Giglio$^{\dagger}$, Timothy J. Smyser$^{\dagger}$}
...
\newcommand{\myAffiliations}{$^*$Fisheries Ecology Division,
    ...
    $^\dagger$  ADDRESS FOR APHIS/NWRC}
\renewcommand{\AuthorAddresses}{\myAffiliations}

\renewcommand{\KeyWords}{genetic stock identification, mixture deconvolution, permutation testing, power analysis, blah, blah}
